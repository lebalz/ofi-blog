...
<Flex>
    <Card imgSrc={require('./images/password.jpg').default} title="Wissen" description="Die Person weiss etwas, z.B. ein Passwort oder eine Pin"/>
    <Card imgSrc={require('./images/keys.jpg').default} title="Besitz" description="Die Person besitzt etwas, z.B. eine Kreditkarte oder einen Schlüssel." />
    <Card imgSrc={require('./images/eye.jpg').default} title="Merkmal" description="Die Person wird über körperliches Merkmal identifiziert, z.B. einen Fingerabdruck oder die Iris."/>
</Flex>
...
## Wissen
Mit dieser Methode authentisiert sich die Person, indem sie eine bestimmte Information **weis**, beispielsweise
