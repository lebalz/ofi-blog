...
- <details>
<summary>Privates Fenster öffnen (<i>Inkognito Mode</i>)</summary>
...
<details>
<summary>Eine Mail-Signatur hinzufügen/ändern.</summary>
...
Etablierte Konvention ist, eine Signatur durch einen Signaturtrenner vom Nachrichtentext abzutrennen. Dieser besteht aus einer Zeile, die nur die Zeichenfolge „-- “ (zwei Bindestriche und ein Leerzeichen) enthält.[3] Dadurch ermöglicht man es den meisten E-Mail-Programmen und Newsreadern, eine Signatur automatisch zu erkennen und beim Antworten nicht zu zitieren.[^2]
