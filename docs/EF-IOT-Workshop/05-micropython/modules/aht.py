"""Driver for AHT2x sensors (humidity and temperature):
    ...
    Codebase intially developed by Jonathan Fromentin: https://github.com/etno712/aht.
"""

import time
from micropython import const

__author__ = "Balthasar Hofer"
__credits__ = ["Jonathan Fromentin"]
__license__ = "CeCILL version 2.1"
__version__ = "1.1.0"
__maintainer__ = "Balthasar Hofer"
...
class AHT2x:
    ...
    @property
    def status(self):
        if self._values["temp"] == INVALID_MEASUREMENT or self._values["hum"] == INVALID_MEASUREMENT:
            return 0
        return 1
    ...
    def _measure(self):
        ...
        if not self.active_crc or (self._crc8() == self._buf[6]):
            ...
            self._values["hum"] = INVALID_MEASUREMENT
            self._values["temp"] = INVALID_MEASUREMENT