...
<div>
<Flex>
    <Card imgSrc={require('./images/unicode-0041.png').default} description={<a href="https://unicode-table.com/de/0041/">Lateinischer Grossbuchstaben A <code>U+0041</code></a>} justifyContent="space-between" spacer/>
    <Card imgSrc={require('./images/unicode-3084.png').default} description={<a href="https://unicode-table.com/de/3084/">Hiragana-Buchstabe Ya <code>U+3084</code></a>} justifyContent="space-between" spacer/>
    <Card imgSrc={require('./images/unicode-13CD.png').default} description={<a href="https://unicode-table.com/de/13CD/">Cherokee-Buchstabe S <code>U+13CD</code></a>} justifyContent="space-between" spacer/>
    <Card imgSrc={require('./images/unicode-1F0B9.png').default} description={<a href="https://unicode-table.com/de/1F0B9/">Spielkarte Neun der Herzen <code>U+1F0B9</code></a>} justifyContent="space-between" spacer/>
</Flex>

<Flex>
    <Card imgSrc={require('./images/unicode-1F92F.png').default} description={<a href="https://unicode-table.com/de/1F92F/">Entsetztes Gesicht mit explodierendem Kopf <code>U+1F92F</code>
</a>} justifyContent="space-between" spacer/>
    <Card imgSrc={require('./images/unicode-1F412.png').default} description={<a href="https://unicode-table.com/de/1F412/">Affe <code>U+1F412</code></a>} justifyContent="space-between" spacer/>
    <Card imgSrc={require('./images/unicode-23FB.png').default} description={<a href="https://unicode-table.com/de/23FB/">Power-Symbol <code>U+23FB</code></a>} justifyContent="space-between" spacer/>
    <Card imgSrc={require('./images/unicode-1322C.png').default} description={<a href="https://unicode-table.com/de/1322C/">Ägyptische Hieroplyphe Nl012 <code>U+1322C</code></a>} justifyContent="space-between" spacer/>
</Flex>
</div>
