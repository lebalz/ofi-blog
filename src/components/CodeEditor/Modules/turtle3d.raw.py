...
Turtle.GRBL_PRUSA_START = '''; generated by PrusaSlicer 2.5.0+win64 on 2023-01-05 at 10:01:54 UTC
...
def _grbl_goto(self, x, y):
    ...
    if self._drawing:
        self.gcodes.append(f'G1 X{x + self.PRUSA_OFFSET[0]:.3f} Y{y + self.PRUSA_OFFSET[1]:.3f} E{(dist * self.LAYER_HEIGHT / 450):.5f}')
    else:
