...
_td_extended_defs.append('GRBL_PRUSA_START')
...
_td_extended_defs.extend(['LAYER_HEIGHT', '_elevation', '_elevations', 'PRUSA_OFFSET', 'PRUSA_DIMENSION', 'gcodes', 'layer_change_code', 'history'])
...
__done = turtle.done
def _reset():
    Turtle._goto = Turtle.__goto
    for cmd in _td_extended_defs:
        delattr(Turtle, cmd)
    turtle.done = __done
