          ...
          {sidebar_custom_props.source && (
            <>
              {sidebar_custom_props.source.name && (
                <a href={sidebar_custom_props.source.ref || '#'} className={clsx(styles.copyright, "badge", "badge--primary")}>
                  {sidebar_custom_props.source.name}
                  {sidebar_custom_props.source.ref && (<i className='mdi mdi-open-in-new' style={{marginLeft: '0.3em'}}></i>)}
                </a>
              )}
