...
import Latin1Sample from '@site/versioned_docs/version-25h/05-Codierung/01-Zeichencodierung/_latin1-sample.mdx';
import Latin1Table from '@site/versioned_docs/version-25h/05-Codierung/01-Zeichencodierung/_latin1-table.mdx';
